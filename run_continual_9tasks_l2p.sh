...
#   POOL_SIZE=10 PROMPT_LENGTH=10 TOP_K=4 EMBEDDING_KEY=mean STEPS_PER_TASK=100 bash run_continual_9tasks_l2p.sh
#
# With custom GPU:
#   CUDA_VISIBLE_DEVICES=3 TASK_ORDER=036147258 bash run_continual_9tasks_l2p.sh
...
# Build command
CMD="python train_continual.py --config-name continual_learning_9tasks_l2p"
