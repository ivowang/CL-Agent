...
class ActorRolloutRefWorker(VerlActorRolloutRefWorker):
    ...
    Extended with continual learning support.
    """
    
    def set_cl_config(self, cl_config):
        """
        Set continual learning configuration for the actor.
        ...
        Args:
            cl_config: CL configuration dict containing:
                ...
                - frozen_lora_params: Frozen LoRA params from previous tasks
        """
