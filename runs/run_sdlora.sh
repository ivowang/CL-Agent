...
#   bash runs/run_sdlora.sh
#
#   # Train with predefined orderings
#   TASK_ORDER=012345678 bash runs/run_sdlora.sh  # Order 1: Env-first, LMH
#   TASK_ORDER=210543876 bash runs/run_sdlora.sh  # Order 2: Env-first, HML
#   TASK_ORDER=036147258 bash runs/run_sdlora.sh  # Order 3: Diff-first, LMH
#   TASK_ORDER=258147036 bash runs/run_sdlora.sh  # Order 4: Diff-first, HML
#
#   # Custom hyperparameters
#   SCALING_FACTOR_INIT=0.5 bash runs/run_sdlora.sh
#
#   # Resume from checkpoint
#   RESUME_CHECKPOINT=/path/to/checkpoint bash runs/run_sdlora.sh
#
#   # Use specific GPUs
#   CUDA_VISIBLE_DEVICES=0,1,2,3 bash runs/run_sdlora.sh
...
# Build command
CMD="python train_scripts/train_continual.py --config-name continual_learning_9tasks_sdlora"
