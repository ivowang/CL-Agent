...
#
# Usage:
#   bash runs/run_moe.sh
#
# With custom parameters:
#   TOTAL_STEPS=900 TEST_FREQ=20 bash runs/run_moe.sh
#
# With custom GPU:
#   CUDA_VISIBLE_DEVICES=0 bash runs/run_moe.sh
#
...
# Build command
CMD="python train_scripts/train_moe.py --config-name moe_training_9tasks"
