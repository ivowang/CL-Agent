...
#
# Usage:
#   ENV_TAG=BanditLow bash runs/run_memorybank.sh
#   ENV_TAG=SokobanMedium BUFFER_SIZE=30 TOP_K=6 bash runs/run_memorybank.sh
#   CUDA_VISIBLE_DEVICES=0 ENV_TAG=FrozenLakeHard bash runs/run_memorybank.sh
...
CMD="python train_scripts/train_memorybank.py --config-name memorybank"
