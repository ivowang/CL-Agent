...
#   TOTAL_STEPS=900 TEST_FREQ=20 bash runs/run_mix.sh
#
#   # Select a custom task subset
#   MIX_TASKS=BanditLow,SokobanMedium,FrozenLakeHard bash runs/run_mix.sh
#
#   # Use specific GPUs
#   CUDA_VISIBLE_DEVICES=4 bash runs/run_mix.sh
...
# Build command
CMD="python train_scripts/train_mix.py --config-name mix_training_9tasks"
