...
#
# Usage:
#   bash runs/run_hideprompt.sh
#
# With custom parameters:
#   REG_WEIGHT=0.1 PROMPT_LENGTH=5 TASK_ORDER=012345678 bash runs/run_hideprompt.sh
#
# With custom GPU:
#   CUDA_VISIBLE_DEVICES=3 TASK_ORDER=036147258 bash runs/run_hideprompt.sh
#
...
# Build command
CMD="python train_scripts/train_continual.py --config-name continual_learning_9tasks_hideprompt"
