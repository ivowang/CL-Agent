...
#   bash run_continual_9tasks_olora.sh
#
#   # Train with predefined orderings
#   TASK_ORDER=012345678 bash run_continual_9tasks_olora.sh
#   TASK_ORDER=036147258 bash run_continual_9tasks_olora.sh
#
#   # Custom hyperparameters
#   LAMBDA_ORTHO=0.3 LAMBDA_L2=0.01 bash run_continual_9tasks_olora.sh
#
#   # Resume from checkpoint
#   RESUME_CHECKPOINT=/path/to/checkpoint bash run_continual_9tasks_olora.sh
#
#   # Use specific GPUs
#   CUDA_VISIBLE_DEVICES=0,1,2,3 bash run_continual_9tasks_olora.sh
...
# Build command
CMD="python train_continual.py --config-name continual_learning_9tasks_olora"
