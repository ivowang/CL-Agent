#!/bin/bash
#
# O-LoRA Continual Learning Launcher
#
# Launches O-LoRA CL training on all 4 task orders using specified GPUs.
...
#
# Usage:
#   bash launch_olora.sh GPU1 GPU2 GPU3 GPU4
#
# Example:
#   bash launch_olora.sh 0 1 2 3    # Use GPUs 0,1,2,3
#   bash launch_olora.sh 4 5 6 7    # Use GPUs 4,5,6,7
#
# With custom hyperparameters:
#   LAMBDA_ORTHO=0.3 LAMBDA_L2=0.01 bash launch_olora.sh 0 1 2 3
#
...
# Check arguments
if [ $# -ne 4 ]; then
    echo "Usage: bash launch_olora.sh GPU1 GPU2 GPU3 GPU4"
    echo "Example: bash launch_olora.sh 0 1 2 3"
    exit 1
fi
...
echo "=============================================================="
echo "Launching O-LoRA CL Training on 4 Task Orders"
echo "=============================================================="
echo "GPUs: ${GPUS[*]}"
...
for i in {0..3}; do
    ...
    CMD="cd $SCRIPT_DIR && CUDA_VISIBLE_DEVICES=$GPU TASK_ORDER=$TASK_ORDER$EXTRA_ARGS bash run_continual_9tasks_olora.sh"
    tmux send-keys -t "$SESSION_NAME" "$CMD" Enter
done

echo ""
echo "=============================================================="
echo "All 4 O-LoRA trainings launched!"
echo "=============================================================="
echo ""
