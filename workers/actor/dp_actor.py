...
from cl_methods.loss_functions import compute_olora_loss, get_cl_loss_fn
...
class DataParallelPPOActor(BasePPOActor):
    ...
    def _reinitialize_lora_for_new_task(self) -> None:
        ...
        from cl_methods.multi_lora import reinitialize_lora_for_new_task
    ...
    def _compute_hideprompt_contrastive_loss(self) -> Tuple[torch.Tensor, Dict[str, float]]:
        ...
        Returns:
            Tuple of (loss tensor, metrics dict)
        """
        from cl_methods.trajectory_storage import compute_contrastive_loss
