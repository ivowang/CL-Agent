...
#   TASK_ORDER=012345678 bash run_continual_9tasks.sh  # Order 1: Env-first, LMH
#   TASK_ORDER=210543876 bash run_continual_9tasks.sh  # Order 2: Env-first, HML
#   TASK_ORDER=036147258 bash run_continual_9tasks.sh  # Order 3: Diff-first, LMH
#   TASK_ORDER=258147036 bash run_continual_9tasks.sh  # Order 4: Diff-first, HML
#
#   # Resume from checkpoint
#   RESUME_CHECKPOINT=/path/to/checkpoint bash run_continual_9tasks.sh
#
#   # Use specific GPUs
#   CUDA_VISIBLE_DEVICES=0 TASK_ORDER=012345678 bash run_continual_9tasks.sh
...
# Build command
CMD="python train_continual.py --config-name continual_learning_9tasks"
